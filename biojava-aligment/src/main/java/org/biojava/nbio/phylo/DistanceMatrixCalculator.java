...
public class DistanceMatrixCalculator {
    ...
    private final static String LOG= DistanceMatrixCalculator.class.getSimpleName();
...
//		Log.i("{}:{}", "Determing Distances", 0);
		...
		int loopcount = 0;
		for (int i = 0; i < (n - 1); i++) {
			Log.i(LOG,""+loopcount+":"+totalloopcount+" Determining Distances"+ (loopcount* 100)/ totalloopcount);
...
//		Log.i("{}:{}", "Determining Distances", 100);
