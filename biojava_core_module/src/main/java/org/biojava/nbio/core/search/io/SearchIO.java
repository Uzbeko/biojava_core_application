...
public class SearchIO implements Iterable<Result>{
    ...
    public static class SearchIOstream implements Iterable<Result>{
         ...
         * @throws Exception
         */
        public SearchIOstream(File f)  throws IOException, ParseException{
            factory = guessFactory(f);
            file = f;
            if (file.exists()) readResults();
        }
         ...
         * @throws ParseException for file format related issues
         */
        public SearchIOstream(File f, ResultFactory_V2 factory) throws IOException, ParseException{
            file = f;
            this.factory = factory;
            if (file.exists()) readResults();
        }
         ...
         * @throws ParseException for file format related issues
         */
        public SearchIOstream(File f, ResultFactory_V2 factory, double maxEvalue) throws IOException, ParseException{
            file = f;
            this.factory = factory;
            this.evalueThreshold = maxEvalue;
            if (file.exists()) readResults();
